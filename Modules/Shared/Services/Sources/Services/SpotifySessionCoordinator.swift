...
public final class SpotifySessionCoordinator {
    ...
    public init(tokenStore: SpotifyKeychainTokenStore = SpotifyKeychainTokenStore()) {
...
public final class SpotifySessionCoordinator {
    ...
    public private(set) var accountDescriptor: String = "SpotifySDK is not linked to this target."
