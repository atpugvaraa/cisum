...
public struct SuggestionCandidate {
    ...
    public let successfulPlays: Int
    public let recency: Date
    public let sourceBoost: Double
    
    public init(text: String, frequency: Int, successfulPlays: Int, recency: Date, sourceBoost: Double) {
        self.text = text
        self.frequency = frequency
        self.successfulPlays = successfulPlays
        self.recency = recency
        self.sourceBoost = sourceBoost
    }
}

public enum SuggestionRanker {
    public static func rank(input: String, candidates: [SuggestionCandidate], limit: Int = 8) -> [String] {
