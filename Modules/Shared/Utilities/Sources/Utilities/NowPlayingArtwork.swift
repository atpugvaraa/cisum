...
public nonisolated func normalizedITunesArtworkURL(from artworkURLString: String?) -> URL? {
...
public nonisolated func normalizedMotionArtworkAlbumCacheKey(albumName: String?, artistName: String?) -> String? {
...
public nonisolated func motionArtworkCollectionCacheKey(collectionID: Int?) -> String? {
...
public nonisolated func motionArtworkCatalogAlbumCacheKey(catalogAlbumID: String?) -> String? {
