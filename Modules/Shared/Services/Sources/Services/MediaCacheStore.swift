...
public enum PlaybackCandidateBuilder {
...
@MainActor
public final class MediaCacheStore {
    ...
    public init(context: ModelContext, imageFileStore: ArtworkImageFileStore = .shared) {
    ...
    public func cachedHighQualityArtworkURL(for mediaID: String, maxAge: TimeInterval) -> URL? {
        guard let entry = fetchEntry(for: mediaID),
              ...
              let url = url(from: entry.artworkURLString) else {
            return nil
        }
