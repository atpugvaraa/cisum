...
struct ExpandablePlayer: View {
    ...
    @State private var properties = PlayerProperties()
    ...
    var body: some View {
        GeometryReader { proxy in
            ...
            .frame(height: properties.expandPlayer ? nil : 55, alignment: .top)
            .frame(maxHeight: .infinity, alignment: .bottom)
            .padding(.bottom, properties.expandPlayer ? 0 : safeArea.bottom + 55)
            .padding(.horizontal, properties.expandPlayer ? 0 : 15)
    ...
    var background: some View {
        ...
        .clipShape(.rect(cornerRadius: properties.expandPlayer ? deviceCornerRadius : 15))
        .frame(height: properties.expandPlayer ? nil : 55)
    }
